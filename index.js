...
try {
  if (!matches || !deliveries || !matches.length || !deliveries.length) {
  ...
  const extraRunsByTeam = getExtraRunsByTeamInaSeason(
    matches,
    deliveries,
    2016
  );
  ...
  writeFile(
    ...
    "4-top-10-economical-bowlers-year-2015.json"
  );
  writeFile(
  ...
  console.log("All data processed and written successfully.");
} catch (error) {
